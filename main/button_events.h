...
typedef enum {
    ...
    BTN_SETTINGS_AUTH_UNLOCK,
    BTN_SETTINGS_LOCKED_MORE,
    BTN_SETTINGS_LOCKED_MORE_EXIT,
    BTN_SETTINGS_PREFS,
    ...
    BTN_SETTINGS_BIP85,
    BTN_SETTINGS_EVM,
    BTN_SETTINGS_EVM_RECEIVE,
    BTN_SETTINGS_EVM_SIGN,
    BTN_SETTINGS_EVM_METAMASK_QR,
    BTN_SETTINGS_EVM_CONFIG,
    BTN_SETTINGS_EVM_CONFIG_QR,
    BTN_SETTINGS_EVM_ERASE,
    BTN_EVM_OPTIONS_EXIT,
    BTN_EVM_OPTIONS_ACCOUNT,
    BTN_EVM_OPTIONS_CHANGE,
    BTN_EVM_OPTIONS_INDEX,
    BTN_EVM_OPTIONS_CONTINUE,
    BTN_SETTINGS_OTP,
